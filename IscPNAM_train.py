...
import utils## use for IscPNAM training
import numpy as np
...
def main():
    ...
    if meta:## did not use in IscPNAM
    ...
    if singleTask:## did not use in IscPNAM
    ...
    if meta or gencode:
        ...
        model = utils.IscPNAMNet(num_tfs,num_recurrent,num_bigwigs)
